...
class SliderController extends Controller
{
    ...
    {
        $slider = Slider::leftJoin('media', function($join) {
    ...
    public function show($id)
    {
        ...
        $media = media::where('reference_id',$id)->where('reference_type','slider')->get()->first();
        return view('management/slider/edit',compact('slider','media'));
    }
