...
@if($coupon)
    @foreach($coupon as $coupons)
        ...
        <div class="row py-2 w-100 mx-auto my-2 shadow-sm rounded-4">
...
{{--                    <a class="text-dark" href="{{url('coupons',$coupons['basic']->slug)}}">--}}
                    ...
                    <img src="{{asset('images/media/'.$image)}}?v={{rand(10,140000)}}" class="w-100 p-2" height="80px" style="    background: white;object-fit:contain" alt="{{$coupons['basic']->title}} hot Deal">
                    </a>
                </div>
            </div>
            <div class="col-lg-8 col-md-8 col-sm-8 col-8 my-2">
                ...
                <div class="side-pd-content">
                    ...
                    <p class=" fs-6 m-0" style="font-weight: 700;">
