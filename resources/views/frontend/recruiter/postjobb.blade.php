                            ...
                            <div class="form-group ms-0 accInfoStl w-100 bg-white text-dark p-5 my-4">
                                ...
                                <div class="col-12">
                                    ...
                                    @foreach($location as $locat)
                                            <option value="{{$locat->id}}">{{$locat->location_name}}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group ms-0 accInfoStl w-100 bg-white text-dark p-5 my-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control w-100 mb-2" id="loc_postcode"
                                           name="postcode" placeholder="Location and Postcode">
                                </div>
                            </div>
                            <div class="form-group ms-0 accInfoStl w-100 bg-white text-dark p-5 my-4">
                                <div class="col-12">
                                    <label>
                                        <input type="checkbox" checked="checked" name="advertise_job" value="1">
                                ...
                                <div class="mainPay">
                                    ...
                                    <div class="css-tl71gl e1ttgm5y0"><label for="local.temp-salary.period"
                                        ...
                                        <div class=" showPaySelect"><select aria-invalid="false"
                                                ...
                                                <option label="per hour" value="per hour">per hour</option>
                                                <option label="per day" value="per day">per day</option>
                                                <option label="per week" value="per week">per week</option>
                                                <option label="per month" value="per month">per c</option>
                                                <option label="per year" value="per year">per year</option>
                        ...
                        <fieldset id="textEditorDesc" class="text-start">
                            ...
                            <div class="form-group ms-0 accInfoStl w-100 bg-white text-dark p-5 my-4">
                                <label for="rec" class="col-12 control-label">Job description <span
                                        ...
                                        *</span></label>
                                <div class="col-12">
                                    <textarea id="summernote" name="job_description">
                                    </textarea>
                                </div>
                            </div>
                            <div class="form-group ms-0 w-100 bg-white text-dark p-5 my-4">
                                <label for="" class="col-12 control-label">Job Post Image<span
                                            class="text-dark">
                                        *</span></label>
