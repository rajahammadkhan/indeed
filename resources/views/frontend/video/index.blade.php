...
@endsection
@section('content')
<div class="container-fluid pd_comment_sec mb-3 shadow-sm d-flex ">
    <div class="row">
        <div class="col-12 w-100 py-3 text-black fs-6">
                    ...
                    <div class="vd_controls px-2 d-flex justify-content-between align-items-center">
                        ...
                        <div class="rights">
                            <div class="two d-flex ms-1 align-items-center">
                                <img src="{{asset('frontend/img/Path 81.png')}}" style="width: 16px; filter: invert(1) brightness(1.5);" alt="eye">
                                <p class="mb-0 mx-1 text-white" style="font-size: 11px;">
                                    12
                                </p>
                            </div>
            ...
            <div class="main vd shadow mx-0">
                <div class="content row p-2 py-3">
                    <div class="col-3 pe-0 my-auto">
                        <img src="{{asset('/images/profile/'.$row['user']->image)}}" class="w-75" alt="">
                    </div>
