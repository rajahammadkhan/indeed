<div class="col-lg-3 col-md-3 col-sm-12 bg-signature  rounded-4 text-center pt-3">
        ...
        <div class="d-flex justify-content-center mb-4">
            <div class="profile-image-outer-container">
                <div class="profile-image-inner-container " style="background-color: #d4d4d4;">
                    ...
                    <img src="{{asset('images/profile'.'/'.$image)}}" alt="{{auth()->user()->image.' Dashboard'}}">
...
{{--        </div>--}}
    ...
    <div class="row p-0 mt-3 rounded-4 bg-white">
