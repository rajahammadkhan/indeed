                ...
                <div class="col-md-4 col-12 my-auto text-start">
                    <div class="jbe-form-container card shadow p-4">
                        <form action="#" method="post" id="create-jbe">
                            ...
                            <p class="text--small mt20">By creating a job alert with 4Fresh you agree to our <a
        ...
        <div class="col-md-6 col-12 my-4">
            ...
            <div class="itm my-4">
                ...
                <h5 class="text-dark fw-light mb-2">
                    Keep up-to-date with the latest jobs matching your criteria search within the Fresh Produce and Agriculture Industries
                    Our alerts are easy to review on all devices, including desktop, mobile and email.
                    Be the first to apply for that perfect job for you on 4fresh.co.uk.
                    Apply in seconds with our 1-Click apply process.
            ...
            <div class="itm my-4">
                ...
                <h5 class="text-dark fw-light mb-2">
                    It takes less than one minute to create a Job Alert on 4Fresh.
                    You can manage your alerts at any time and can create multiple alerts to receive the jobs you want to receive for multiple locations
                    Dont delay let us do the work for you right now your perfect job could be with you within 24 hours
                </h5>
            </div>
