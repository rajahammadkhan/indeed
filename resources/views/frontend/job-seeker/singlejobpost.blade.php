                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="jobDetails my-4">
                                    ...
                                    <h6 class="text-dark">
                                        Posted by <a href="#"> {{$post_job['username']->name}}</a>
                                    </h6>
                                    <h6 class="loc text-dark my-3 mb-4">
                                        ...
                                        </svg> {{$post_job['location']->location_name}}
                                    </h6>
                                </div>
                                <div class="jobDescr">
                                    <h4 class="text-dark">
                                    ...
                                    @if (Auth::check())
                                    <div class="apply"><a href="{{url('applied-job')}}"><button class="btn btn-primary">Apply Now</button></a></div>
                                    @else
                                    <div class="apply"><a href="{{url('login')}}"><button class="btn btn-primary">Apply Now</button></a></div>
                                    @endif
                                </div>
                            </div>
                        </div>
