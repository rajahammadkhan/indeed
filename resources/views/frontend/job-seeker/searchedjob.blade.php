                        ...
                        <div class="findJobCard  bg-white p-3">
                            <div class="row">
                                <div class="col-sm-3 col-12 my-auto">
                                    @if($job->image!= null)
                                        @php $image = '/'.$job->image @endphp
                                    @else
                                        @php $image = 'galleryimage.png' @endphp
                                    @endif
                                    <img style="" src="{{asset('images/media'.'/'.$image)}}" alt="findJobImg" class="w-100 findJobImg" draggable="false">
                                </div>
                                <div class="col-sm-9 col-12">
                                    <a href="{{route('searched-job.show',$job->id)}}" class="para findJobTitle"> <span
                                            class="findJobMatchKeyword">
                                            {{$job->job_title}}
                                        </span></a>
                                    <div class="posted">
                                        <h6 class="text-dark">Posted 4 days ago by <a href="#">{{$job['username']->name}}</a>
                                        </h6>
                                    </div>
                                    <div class="dtss my-3">
                                        <div class="salary">
                                            <h6 class="text-dark"><span class="fw-light"> Salary:</span>
                                                {{$job->minimum_pay}} to {{$job->maximum_pay}} {{$job->pay_rate}}</h6>
                                        </div>
                                        <div class="industry">
                                            <h6 class="text-dark"><span class="fw-light"> Industry:</span>
                                                {{$job['industry']->industry_name}}</h6>
                                        </div>
                                        <div class="location">
                                            <h6 class="text-dark"><span class="fw-light"> Location:</span>
                                                {{$job['location']->location_name}}</h6>
                                        </div>
                                        <div class="jobtype">
                                        ...
                                        <div class="department">
                                            <h6 class="text-dark"> <span class="fw-light"> Department:</span>
                                                {{$job['depart']->depart_name}}</h6>
                                        </div>
                                    </div>
                                    <div class="jobDescription">
                                        <h5 class="text-dark findJobDecs">
                                            <span class="fw-light"> Job Description: </span>{!!$job['job_description']!!}
                                        </h5>
                                    </div>
                                    <div class="applyNow mt-4">
                                        <a href="{{route('searched-job.show',$job->id)}}"><button class="btn-success btn">
                                            Apply Now
                                            </button></a>
                                    </div>
                                </div>
...
{{--                                </div>--}}
{{--                                <div class="col-sm-9 col-12">--}}
{{--                                    <a href="{{ url('single-job') }}" class="para findJobTitle">Trainee <span--}}
{{--                                            class="findJobMatchKeyword">--}}
{{--                                            Software--}}
{{--                                            Developer</span>--}}
{{--                                        Course</a>--}}
...
{{--                                </div>--}}
{{--                                <div class="col-sm-9 col-12">--}}
{{--                                    <a href="{{ url('single-job') }}" class="para findJobTitle">Renewable Energy and--}}
{{--                                        Carbon Advisory Senior--}}
{{--                                        Consultant--}}
{{--                                        Course</a>--}}
{{--                                    <div class="posted">--}}
{{--                                        <h6 class="text-dark">Posted 04/10/2022 by <a href="#"> Schneider--}}
{{--                                                Electric</a></h6>--}}
{{--                                    </div>--}}
{{--                                    <div class="dtss my-3">--}}
