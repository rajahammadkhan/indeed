<title>
{{--    @yield('title')--}}
    {!!  isset($seo) ? $seo->meta_title : '4Fresh' !!}
</title>
    ...
    <link rel="manifest" href="https://eliteblue.net/affiliate/public/images//site.webmanifest">
<meta charset="utf-8">
<meta name="title" content="{{ isset($seo) ? $seo->meta_title : 'Discount Space | Best Deals and Coupons' }}">
<meta name="description"
      content="{{   isset($seo) ? htmlspecialchars($seo->meta_description) :
...
<meta name="keywords" content="{{ isset($seo) ? $seo->meta_keywords : 'Best Deals , Best Coupons, SALE, Amazon Deals , 50% Off, Hyper Discount, Flash Sale, Festive Sale, Festive Deals' }}">
