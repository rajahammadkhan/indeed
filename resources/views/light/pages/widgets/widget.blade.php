        ...
        <div class="row state-overview">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box5 animate-bar bg-b-purple">
                    <div class="knob-icon">
                        <input type="text" class="dial" value="45" data-width="80" data-height="80"
                               data-fgColor="#67de69">
                    </div>
                    <div class="info-box-content">
                        <span class="info-box-text">Projects</span>
                        <div class="progress m-t-20">
                            <div class="progress-bar l-bg-green shadow-style width-per-45" role="progressbar"
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box5 animate-bar bg-b-purple">
                    <div class="knob-icon">
                        <input type="text" class="dial" value="69" data-width="80" data-height="80"
                               data-fgColor="#f98050">
                    </div>
                    <div class="info-box-content">
                        <span class="info-box-text">Clients</span>
                        <div class="progress m-t-20">
                            <div class="progress-bar l-bg-orange shadow-style width-per-45" role="progressbar"
                                 aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <span class="progress-description">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box5 animate-bar bg-b-purple">
                    <div class="knob-icon">
                        <input type="text" class="dial" value="84" data-width="80" data-height="80"
                               data-fgColor="#8FD8FE">
                    </div>
                    <div class="info-box-content">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box5 animate-bar bg-b-purple">
                    <div class="knob-icon">
                        <input type="text" class="dial" value="56" data-width="80" data-height="80"
                               data-fgColor="#ac8bde">
                    </div>
                    <div class="info-box-content">
                        <span class="info-box-text">Task</span>
                        <div class="progress m-t-20">
                            <div class="progress-bar l-bg-purple shadow-style width-per-45" role="progressbar"
                                 aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <span class="progress-description">
                            ...
                            <ul class="feedBody">
                                <li class="active-feed">
                                    <div class="feed-user-img">
                                        <img src="../../assets/images/user/user1.jpg" class="img-radius "
                                ...
                                <li class="diactive-feed">
                                    <div class="feed-user-img">
                                        <img src="../../assets/images/user/user2.jpg" class="img-radius "
                                             alt="User-Profile-Image">
                                    </div>
                                    <h6>
