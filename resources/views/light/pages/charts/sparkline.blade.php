...
@section('title')
    Sparkline - {{config('app.dashboard')}}
@endsection
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="sparkline" data-type="line" data-spot-Radius="3"
                             ...
                             data-height="150px" data-line-Width="2" data-line-Color="rgb(0, 188, 212)"
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="sparkline" data-type="bar" data-width="97%" data-height="150px"
                             data-bar-Width="16" data-bar-Spacing="7" data-bar-Color="rgb(0, 188, 212)">
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                ...
                                <p>
                                    Inline
                                    <span class="sparkline-1">10,8,9,3,5,8,5</span> line graphs
                                ...
                                <p>
                                    ...
                                    <br> Discrete with threshold
                                    <span id="discrete2">4,6,7,7,4,3,2,1,4</span>
                                </p>
                                <p>
                                    Bullet charts
                                    <br>
                                    <span class="sparkbullet">10,12,12,9,7</span>
                                    <br>
                                    <span class="sparkbullet">14,12,12,9,7</span>
                                    <br>
                                    <span class="sparkbullet">10,12,14,9,7</span>
                                    <br>
                                </p>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <p>
                                    Tristate charts
                                    <span class="sparktristate">1,1,0,1,-1,-1,1,-1,0,0,1,1</span>
                                    <br> (think games won, lost or drawn)
                                </p>
                                <p>
                                ...
                                <p>
                                    Box Plot:
                                    <span class="sparkboxplot">4,27,34,52,54,59,61,68,78,82,85,87,91,93,100</span>
                                    <br> Pre-computed box plot
