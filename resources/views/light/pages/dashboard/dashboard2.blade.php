...
@section('title')
    Dashboard2 - {{config('app.dashboard')}}
@endsection
@section('content')
                    ...
                    <div class="body">
                        <div class="recent-comment">
                            <div class="notice-board">
                                <div class="table-img">
                                    <img class="notice-object" src="asset{{('indeed/images/user/user6.jpg')}}" alt="...">
                                </div>
                            ...
                            <div class="notice-board">
                                <div class="table-img">
                                    <img class="notice-object" src="asset{{('indeed/images/user/user4.jpg')}}" alt="...">
                                </div>
                                <div class="notice-body">
                            ...
                            <div class="notice-board">
                                <div class="table-img">
                                    <img class="notice-object" src="asset{{('indeed/images/user/user3.jpg')}}" alt="...">
                                </div>
                                <div class="notice-body">
                            ...
                            <div class="notice-board no-border">
                                <div class="table-img">
                                    <img class="notice-object" src="asset{{('indeed/images/user/user7.jpg')}}" alt="...">
                                </div>
                                <div class="notice-body">
                        ...
                        <ul class="timeline">
                            <li>
                                <div class="timeline-badge primary">
                                    <img class="notice-object" src="asset{{('indeed/images/user/user1.jpg')}}" alt="...">
                                </div>
                            ...
                            <li>
                                <div class="timeline-badge primary">
                                    <img class="notice-object" src="asset{{('indeed/images/user/user2.jpg')}}" alt="...">
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h5 class="timeline-title">Lorem ipsum dolor sit amet, id quo eruditi.</h5>
                            ...
                            <li>
                                <div class="timeline-badge primary">
                                    <img class="notice-object" src="asset{{('indeed/images/user/user8.jpg')}}" alt="...">
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h5 class="timeline-title">Lorem ipsum dolor sit amet, id quo eruditi.</h5>
