        ...
        <div class="col-lg-8 col-md-10 col-12 mx-auto">
            <form class="form-horizontal my-5" action="./modifyJob.html"  id="myform">
                ...
                <fieldset id="textEditorDesc" class="">
                    ...
                    <div class="form-group ms-0 accInfoStl w-100 bg-white text-dark p-5 my-4">
                        <label for="recName" class="col-12 control-label">Job description<span
                                    class="text-danger">
                                        *</span></label>
                        <div class="col-12">
                            <input type="text" class="form-control w-100 mb-2" id="recName" name="recName"
                                   placeholder="Job ddescription">
                        </div>
{{--                        <label for="recName" class="col-12 control-label">Job description <span class="text-danger">--}}
{{--                                *</span></label>--}}
{{--                        <div class="col-12">--}}
