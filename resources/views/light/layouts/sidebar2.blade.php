        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="position-relative">
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="./postJobForm.html">Post Job Now</a>
                        </li>
                        <li>
                            <a href="./modifyJob.html">Modify/Delete Jobs</a>
                        </li>
                        <!-- <li>
                            <a href="#">Current Jobs</a>
                        </li> -->
                        <li>
                            <a href="./modifyJob.html">Job Application</a>
                        </li>
                        <!-- <li>
                            <a href="#">Manage Job Templates</a>
                        </li> -->
                        <li>
                            <a href="./modifyJob.html">Social Job Posting</a>
                        </li>
                        <li>
                ...
                <li class="position-relative">
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="./searchJob.html">Search CVs</a>
                        </li>
                        <li>
                            <a href="./searchJob.html">Recent CVs</a>
                        </li>
                        <li>
                            <a href="./searchJob.html">Saved CVs</a>
                        </li>
                        <li>
                            <a href="./searchJob.html">Saved Searches</a>
                        </li>
                        <li>
                            <a href="./candidateSearch.html">Recently Viewed CVs</a>
                        </li>
                        <li>
                            <a href="./searchJob.html">CV Notes</a>
                        </li>
                        <li>
                            <a href="./searchJob.html">Removed CVs</a>
                        </li>
                        <li>
                            <a href="./searchJob.html">Popular Searches</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="position-relative">
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="./candidateSearch.html">Watchdogs Control Panel</a>
                        </li>
                        <li>
                            <a href="./candidateSearch.html">Create Watchdogs</a>
                        </li>
                        <li>
                            <a href="./candidateSearch.html">Modify Watchdogs</a>
                        </li>
                        <li>
                            <a href="./candidateSearch.html">Watchdogs Sent</a>
                        </li>
                        <li>
                            <a href="./candidateSearch.html">Reactive Watchdogs</a>
                        </li>
                    </ul>
                </li>
                <li class="position-relative">
