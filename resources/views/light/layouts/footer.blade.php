        ...
        <div class="container text-center text-md-start mt-5">
            <div class="row mt-3">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                    ...
                    <a href="https://goo.gl/maps/ZeWR55kQ4yi3ZXsWA"><p><i class="fas fa-home me-3"></i> New York, NY 10012, US</p></a>
                    <p>
...
<script src="{{asset('indeed/js/pages/tables/jquery-datatable.js')}}"></script>
<script src="{{asset('indeed/js/table.min.js')}}"></script>
