                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="breadcrumb breadcrumb-style ">
                        <li class="breadcrumb-item">
                            <h4 class="page-title">Modify Job</h4>
                        </li>
                                        ...
                                        <table
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0"
                                                    ...
                                                    style="width: 139.312px;">Job Type</th>
                                                <th class="sorting" tabindex="0"
                                                    aria-controls="DataTables_Table_0" rowspan="3" colspan="1"
                                                    aria-label="Office: activate to sort column ascending"
                                                    style="width: 139.312px;">Name</th>
                                                <th class="sorting" tabindex="0"
                                                    aria-controls="DataTables_Table_0" rowspan="4" colspan="1"
                                                    aria-label="Age: activate to sort column ascending"
                                                    style="width: 62.9625px;">Date</th>
                                                <th class="sorting" tabindex="0"
                                            ...
                                            <tbody>
                                            @foreach($modify_job as $post_job)
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">
                                                    <a href="{{route('modify-job.show',$post_job->id)}}" class="jobTitle">{{$post_job->job_title}}</a>
                                                    <p class="mb-0 jobInnTxt">
                                                        {{$post_job['location']->location_name}}
                                                    </p>
                                                </td>
                                                <td>
                                                    <div
                                                ...
                                                <td>{{$post_job['job']->job_name}}</td>
                                                <td>{{$post_job['username']->name}}</td>
                                                <td>n/a
                                                <td>{{$post_job->job_status}}</td>
{{--                                                <td>--}}
{{--                                                    <div class="jobStatus">--}}
                                                ...
                                                <td>
                                                    <ul class="header-dropdown m-r--5">
                                                        <li class="dropdown text-center">
                                                            ...
                                                            <ul class="dropdown-menu pull-right">
                                                                <li>
                                                                    <a href="{{route('modify-job.show',$post_job->id)}}">Edit</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#" data-toggle="modal" data-target="#exampleModalCenter{{$post_job->id}}">Delete</a>
                                                                </li>
                                                            </ul>
                                                            <div class="modal fade" id="exampleModalCenter{{$post_job->id}}" tabindex="-1" role="dialog"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <form action="{{route('modify-job.destroy',$post_job->id)}}" method="post">
                                                                                @csrf
                                                                                @method('DELETE')
