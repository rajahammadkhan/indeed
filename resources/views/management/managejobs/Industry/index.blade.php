                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            @can('industry-create')
                                <a href="{{route('industry.create')}}" type="button" class="btn btn-primary"> Add Industry
                                </a>
                            @endcan
                            ...
                            <table class="table" id="myTable">
                                ...
                                @foreach($industry as $row)
                                    <tr>
                                        ...
                                        <td>
                                            @can('industry-edit')
                                                <a class="btn bg-blue btn-circle" href="{{route('industry.show',$row->id)}}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{route('industry.destroy',$row->id)}}" method="post">
                                                                @csrf
                                                                @method('DELETE')
