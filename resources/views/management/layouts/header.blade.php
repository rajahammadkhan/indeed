...
<head>
    ...
    <link rel="icon" href="https://onthevouch.com/public/management/images/log.png" type="image/x-icon">
...
<body class="light">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30">
                <img class="loading-img-spin" src="{{ asset('management/images/reload.png') }}" width="20"
                    height="20" alt="admin">
            </div>
            <p>Please wait...</p>
        </div>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">
                    <img height="35px" src="{{ asset('management/images/load.png') }}"
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown user_profile">
                        <a href="#" onClick="return false;" class="dropdown-toggle" data-toggle="dropdown"
                            role="button">
                            <img src="{{ asset('management/images/user.jpg') }}" width="32" height="32"
                                alt="{{ config('app.dashboard') }} | User">
                        </a>
