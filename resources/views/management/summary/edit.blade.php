        ...
        <div class="container ">
            <div class="row">
                <div class="col-lg-8 col-md-10 col-12 mx-auto">
                    <form action="{{ route('edit-summary.save_summary') }}" method="POST">
                        @csrf
                        <fieldset id="account_information" class="">
                            ...
                            <div class="form-group ms-0 accInfoStl w-100 bg-white text-dark p-5 my-4">
                                ...
                                <input type="hidden" name="id" value="@foreach ($data as $item){{$item->id}}@endforeach" /> 
                                <textarea class="form-control" name="summary">@foreach ($data as $item){{$item->summary}}@endforeach</textarea>
                            </div> 
